...
class CustomerOrdersPage extends Component {
  ...
  componentDidMount() {
    ...
    this.props.loadMeal();
    const cbg = this.state.mealReducer;
    console.log(cbg);
    // setTimeout(() => {
    //   this.props.loadMeal();
    // }, 5000);
  ...
  showDrawer() {
    this.props.loadOneMeal(currentOrder.mealId);
    this.setState({
      visible: true,
    });
  }
 ...
 */
const mapDispatchToProps = dispatch => bindActionCreators({ loadOrders, loadMeal, loadOneMeal }, dispatch);
